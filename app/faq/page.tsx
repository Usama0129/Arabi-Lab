  ...
  const faqs = [
    {
      ...
      a: "無料プランでは初級コンテンツの一部のみ利用可能です。プレミアムプラン（月額500円）にご登録いただくと、すべての中級・上級記事、リスニング機能、広告非表示など、全機能が無制限でご利用いただけます。"
    },
    {
      q: "支払い方法は何がありますか？",
    ...
    {
      q: "まったくの初心者でも大丈夫ですか？",
      a: "はい。文字の書き方や発音から学べる「初級」コースをご用意しています。まずは無料プランで、基本的な読み書きを試してみてください。"
    },
    {
      q: "スマートフォンで使えますか？",
