...
// ★ここに "listening" と "grammar_basic" を追加しました
export type QuestionType = 
  ...
  | "orthography" 
  | "grammar_advanced"
  | "listening"       // 追加: リスニング問題用
  | "grammar_basic";  // 追加: 初級文法問題用
...
export type Sentence = {
  arabic: string;
  japanese: string;
  speaker?: string; // 会話形式の場合に話者ラベル ("A", "B" など) を入れる
};
...
// リスニング問題
{
  ...
  category: "挨拶",
  title: "挨拶と自己紹介",
  videoUrl: "https://www.youtube.com/watch?v=-5z2xi-z55E",
  contentPlain: "أ: السلام عليكم.\nب: وعليكم السلام.\nأ: كيف حالك؟\nب: أنا بخير والحمد لله. وأنت؟\nأ: وأنا أيضا بخير والحمد لله.\nأ: ما اسمك؟\nب: أنا اسمي راشد. وأنت؟\nأ: أنا اسمي محمد.\nب: كم عمرك؟\nأ: عمري تسعة عشر عاما. وأنت؟\nب: أنا عمري ستة وعشرون عاما.\nأ: من أين أنت؟\nب: أنا من الهند. وأنت؟\nأ: أنا من مصر.\nب: إلى أين تذهب؟\nأ: أنا ذاهب إلى العمل.\nب: وماذا تعمل؟\nأ: أنا معلم.\nب: رائع. وأين مدرستك؟\nأ: مدرستي في دبي.\nب: سعدت بلقائك.\nأ: وأنا أيضا سعيد بلقائك. شكرا لك.\nب: عفوا، على الرحب والسعة.\nأ: إلى اللقاء.\nب: إلى اللقاء.",
  contentVoweled: "أ: السَّلَامُ عَلَيْكُمْ.\nب: وَعَلَيْكُمُ السَّلَامُ.\nأ: كَيْفَ حَالُكَ؟\nب: أَنَا بِخَيْرٍ وَالْحَمْدُ لِلَّهِ. وَأَنْتَ؟\nأ: وَأَنَا أَيْضًا بِخَيْرٍ وَالْحَمْدُ لِلَّهِ.\nأ: مَا اسْمُكَ؟\nب: أَنَا اسْمِي رَاشِد. وَأَنْتَ؟\nأ: أَنَا اسْمِي مُحَمَّد.\nب: كَمْ عُمْرُكَ؟\nأ: عُمْرِي تِسْعَةَ عَشَرَ عَامًا. وَأَنْتَ؟\nب: أَنَا عُمْرِي سِتَّةٌ وَعِشْرُونَ عَامًا.\nأ: مِنْ أَيْنَ أَنْتَ؟\nب: أَنَا مِنَ الْهِنْدِ. وَأَنْتَ؟\nأ: أَنَا مِنْ مِصْرَ.\nب: إِلَى أَيْنَ تَذْهَبُ؟\nأ: أَنَا ذَاهِبٌ إِلَى الْعَمَلِ.\nب: وَمَاذَا تَعْمَلُ؟\nأ: أَنَا مُعَلِّمٌ.\nب: رَائِعٌ. وَأَيْنَ مَدْرَسَتُكَ؟\nأ: مَدْرَسَتِي فِي دُبَي.\nب: سَعِدْتُ بِلِقَائِكَ.\nأ: وَأَنَا أَيْضًا سَعِيدٌ بِلِقَائِكَ. شُكْرًا لَكَ.\nب: عَفْوًا، عَلَى الرُّحْبِ وَالسَّعَةِ.\nأ: إِلَى اللِّقَاءِ.\nب: إِلَى اللِّقَاءِ.",
  sentences: [
    { speaker: "A", arabic: "السَّلَامُ عَلَيْكُمْ.", japanese: "こんにちは（平安があなたの上にありますように）。" },
    { speaker: "B", arabic: "وَعَلَيْكُمُ السَّلَامُ.", japanese: "こんにちは（そしてあなたの上にも平安がありますように）。" },
    { speaker: "A", arabic: "كَيْفَ حَالُكَ؟", japanese: "お元気ですか？" },
    { speaker: "B", arabic: "أَنَا بِخَيْرٍ وَالْحَمْدُ لِلَّهِ. وَأَنْتَ؟", japanese: "私は元気です、神のおかげで。あなたは？" },
    { speaker: "A", arabic: "وَأَنَا أَيْضًا بِخَيْرٍ وَالْحَمْدُ لِلَّهِ.", japanese: "私も元気です、神のおかげで。" },
    { speaker: "A", arabic: "مَا اسْمُكَ؟", japanese: "お名前は何ですか？" },
    { speaker: "B", arabic: "أَنَا اسْمِي رَاشِد. وَأَنْتَ؟", japanese: "私の名前はラーシドです。あなたは？" },
    { speaker: "A", arabic: "أَنَا اسْمِي مُحَمَّد.", japanese: "私の名前はムハンマドです。" },
    { speaker: "B", arabic: "كَمْ عُمْرُكَ؟", japanese: "何歳ですか？" },
    { speaker: "A", arabic: "عُمْرِي تِسْعَةَ عَشَرَ عَامًا. وَأَنْتَ؟", japanese: "私は19歳です。あなたは？" },
    { speaker: "B", arabic: "أَنَا عُمْرِي سِتَّةٌ وَعِشْرُونَ عَامًا.", japanese: "私は26歳です。" },
    { speaker: "A", arabic: "مِنْ أَيْنَ أَنْتَ؟", japanese: "出身はどこですか？" },
    { speaker: "B", arabic: "أَنَا مِنَ الْهِنْدِ. وَأَنْتَ؟", japanese: "私はインド出身です。あなたは？" },
    { speaker: "A", arabic: "أَنَا مِنْ مِصْرَ.", japanese: "私はエジプト出身です。" },
    { speaker: "B", arabic: "إِلَى أَيْنَ تَذْهَبُ؟", japanese: "どこへ行くのですか？" },
    { speaker: "A", arabic: "أَنَا ذَاهِبٌ إِلَى الْعَمَلِ.", japanese: "仕事へ行くところです。" },
    { speaker: "B", arabic: "وَمَاذَا تَعْمَلُ؟", japanese: "お仕事は何ですか？" },
    { speaker: "A", arabic: "أَنَا مُعَلِّمٌ.", japanese: "私は教師です。" },
    { speaker: "B", arabic: "رَائِعٌ. وَأَيْنَ مَدْرَسَتُكَ؟", japanese: "素晴らしい。学校はどこですか？" },
    { speaker: "A", arabic: "مَدْرَسَتِي فِي دُبَي.", japanese: "私の学校はドバイにあります。" },
    { speaker: "B", arabic: "سَعِدْتُ بِلِقَائِكَ.", japanese: "お会いできて光栄です。" },
    { speaker: "A", arabic: "وَأَنَا أَيْضًا سَعِيدٌ بِلِقَائِكَ. شُكْرًا لَكَ.", japanese: "私もお会いできて嬉しいです。ありがとう。" },
    { speaker: "B", arabic: "عَفْوًا، عَلَى الرُّحْبِ وَالسَّعَةِ.", japanese: "どういたしまして（歓迎します）。" },
    { speaker: "A", arabic: "إِلَى اللِّقَاءِ.", japanese: "さようなら。" },
    { speaker: "B", arabic: "إِلَى اللِّقَاءِ.", japanese: "さようなら。" }
  ],
  vocabList: [
    { word: "السَّلَامُ عَلَيْكُمْ", meaning: "こんにちは（挨拶）" },
    { word: "كَيْفَ حَالُكَ", meaning: "お元気ですか？" },
    { word: "مَا اسْمُكَ", meaning: "お名前は何ですか？" },
    { word: "سَعِدْتُ بِلِقَائِكَ", meaning: "はじめまして/お会いできて光栄です" },
    { word: "شُكْرًا", meaning: "ありがとう" },
    { word: "عَفْوًا", meaning: "どういたしまして" },
    { word: "إِلَى اللِّقَاءِ", meaning: "さようなら" }
  ],
  questions: [
    { id: 20001, type: "listening", text: "ムハンマド（教師をしている男性）の出身地はどこですか？", options: ["インド", "エジプト", "ドバイ", "日本"], correctIndex: 1, explanation: "会話の中でムハンマドは「私はエジプトからです（أَنَا مِنْ مِصْرَ）」と答えています。インド出身なのはラシードです。" },
    { id: 20002, type: "listening", text: "ラシード（質問をしている男性）の年齢は何歳ですか？", options: ["19歳", "20歳", "26歳", "30歳"], correctIndex: 2, explanation: "ラシードは「私は26歳です（أَنَا عُمْرِي سِتَّةٌ وَعِشْرُونَ عَامًا）」と述べています。19歳なのはムハンマドです。" },
    { id: 20003, type: "listening", text: "ムハンマドはどこへ行く途中でしたか？", options: ["学校（仕事）", "家", "市場", "病院"], correctIndex: 0, explanation: "彼は「仕事へ行きます（أَنَا ذَاهِبٌ إِلَى الْعَمَلِ）」と言い、その後「教師（مُعَلِّم）」であり学校はドバイにあると説明しています。" },
    { id: 20004, type: "grammar_basic", text: "「ありがとうございます」に対する返答として適切なものは？", options: ["إِلَى اللِّقَاءِ (さようなら)", "كَيْفَ حَالُكَ (元気ですか)", "عَفْوًا (どういたしまして)", "أَنَا بِخَيْر (私は元気です)"], correctIndex: 2, explanation: "「شُكْرًا (ありがとう)」に対する一般的な返答は「عَفْوًا (Afwan / どういたしまして)」です。" },
    { id: 20005, type: "grammar_basic", text: "男性に対して「元気ですか？」と聞く時の正しい形は？", options: ["كَيْفَ حَالُكَ (ka)", "كَيْفَ حَالُكِ (ki)", "كَيْفَ حَالُكُم (kum)", "كَيْفَ حَالُهُ (hu)"], correctIndex: 0, explanation: "男性の単数相手（あなた）には「ka (ـكَ)」を使います。女性相手なら「ki」、複数なら「kum」になります。" }
  ]
},
{
  "id": 2001,
  ...
  "category": "レストラン",
  "title": "レストランでの注文と会計",
  "videoUrl": "https://www.youtube.com/watch?v=lNCnHKs4hH0",
  "contentPlain": "راشد: مساء الخير يا أحمد.\nأحمد: مساء الخير يا راشد، كيف حالك؟\nراشد: أنا بخير والحمد لله. لم أرك منذ فترة طويلة.\nأحمد: كنت مشغولاً في بعض الأعمال.\nراشد: ما رأيك أن نتناول الغداء معاً؟\nأحمد: بكل سرور. هل تعرف مطعماً يقدم طعاماً لذيذاً؟\nراشد: نعم، أعرف مطعماً قريباً من محطة المترو.\n(في المطعم)\nالنادل: مساء الخير. تفضلا.\nراشد: من فضلك أحضر لنا قائمة الطعام.\nالنادل: ماذا تريد يا راشد؟\nراشد: أنا أريد بعض قطع الدجاج المشوي.\nالنادل: وأنت ماذا تريد يا أحمد؟\nأحمد: وأنا أريد بعض شرائح اللحم بالإضافة إلى الخبز الطازج والشوربة والسلطة.\nالنادل: هل أحضر لكما شيئاً من المشروبات؟\nراشد: نعم، أنا أريد عصير البرتقال.\nأحمد: أنا أريد كوباً من القهوة.\n(بعد الأكل)\nراشد: عذراً، كم الحساب من فضلك؟\nالنادل: تفضل الفاتورة.\nراشد: تفضل النقود.\nالنادل: شكراً لك، مع السلامة.",
  "contentVoweled": "رَاشِد: مَسَاءُ الْخَيْرِ يَا أَحْمَد.\nأَحْمَد: مَسَاءُ الْخَيْرِ يَا رَاشِد، كَيْفَ حَالُكَ؟\nرَاشِد: أَنَا بِخَيْرٍ وَالْحَمْدُ للهِ. لَمْ أَرَكَ مُنْذُ فَتْرَةٍ طَوِيلَةٍ.\nأَحْمَد: كُنْتُ مَشْغُولًا فِي بَعْضِ الْأَعْمَالِ.\nرَاشِد: مَا رَأْيُكَ أَنْ نَتَنَاوَلَ الْغَدَاءَ مَعًا؟\nأَحْمَد: بِكُلِّ سُرُورٍ. هَلْ تَعْرِفُ مَطْعَمًا يُقَدِّمُ طَعَامًا لَذِيذًا؟\nرَاشِد: نَعَمْ، أَعْرِفُ مَطْعَمًا قَرِيبًا مِنْ مَحَطَّةِ الْمِتْرُو.\n(فِي الْمَطْعَمِ)\nالنَّادِل: مَسَاءُ الْخَيْرِ. تَفَضَّلَا.\nرَاشِد: مِنْ فَضْلِكَ أَحْضِرْ لَنَا قَائِمَةَ الطَّعَامِ.\nالنَّادِل: مَاذَا تُرِيدُ يَا رَاشِد؟\nرَاشِد: أَنَا أُرِيدُ بَعْضَ قِطَعِ الدَّجَاجِ الْمَشْوِيِّ.\nالنَّادِل: وَأَنْتَ مَاذَا تُرِيدُ يَا أَحْمَد؟\nأَحْمَد: وَأَنَا أُرِيدُ بَعْضَ شَرَائِحِ اللَّحْمِ بِالْإِضَافَةِ إِلَى الْخُبْزِ الطَّازَجِ وَالشُّورَبَةِ وَالسَّلَطَةِ.\nالنَّادِل: هَلْ أُحْضِرُ لَكُمَا شَيْئًا مِنَ الْمَشْرُوبَاتِ؟\nرَاشِد: نَعَمْ، أَنَا أُرِيدُ عَصِيرَ الْبُرْتُقَالِ.\nأَحْمَد: أَنَا أُرِيدُ كُوبًا مِنَ الْقَهْوَةِ.\n(بَعْدَ الْأَكْلِ)\nرَاشِد: عُذْرًا، كَمِ الْحِسَابُ مِنْ فَضْلِكَ؟\nالنَّادِل: تَفَضَّلِ الْفَاتُورَةَ.\nرَاشِد: تَفَضَّلِ النُّقُودَ.\nالنَّادِل: شُكْرًا لَكَ، مَعَ السَّلَامَةِ.",
  "sentences": [
    { "speaker": "Rashid", "arabic": "مَسَاءُ الْخَيْرِ يَا أَحْمَد.", "japanese": "こんばんは、アハメド。" },
    { "speaker": "Ahmed", "arabic": "مَسَاءُ الْخَيْرِ يَا رَاشِد، كَيْفَ حَالُكَ؟", "japanese": "こんばんは、ラシード。元気ですか？" },
    { "speaker": "Rashid", "arabic": "أَنَا بِخَيْرٍ وَالْحَمْدُ للهِ. لَمْ أَرَكَ مُنْذُ فَتْرَةٍ طَوِيلَةٍ.", "japanese": "元気です、おかげさまで。長い間会っていませんでしたね。" },
    { "speaker": "Ahmed", "arabic": "كُنْتُ مَشْغُولًا فِي بَعْضِ الْأَعْمَالِ.", "japanese": "いくつかの仕事で忙しかったんだ。" },
    { "speaker": "Rashid", "arabic": "مَا رَأْيُكَ أَنْ نَتَنَاوَلَ الْغَدَاءَ مَعًا؟", "japanese": "一緒に昼食を食べるのはどうかな？" },
    { "speaker": "Ahmed", "arabic": "بِكُلِّ سُرُورٍ. هَلْ تَعْرِفُ مَطْعَمًا يُقَدِّمُ طَعَامًا لَذِيذًا؟", "japanese": "喜んで。美味しい料理を出すレストランを知っているかい？" },
    { "speaker": "Rashid", "arabic": "نَعَمْ، أَعْرِفُ مَطْعَمًا قَرِيبًا مِنْ مَحَطَّةِ الْمِتْرُو.", "japanese": "ああ、地下鉄駅の近くにあるレストランを知っているよ。" },
    { "speaker": "Waiter", "arabic": "مَسَاءُ الْخَيْرِ. تَفَضَّلَا.", "japanese": "こんばんは。どうぞ（お座りください）。" },
    { "speaker": "Rashid", "arabic": "مِنْ فَضْلِكَ أَحْضِرْ لَنَا قَائِمَةَ الطَّعَامِ.", "japanese": "すみません、メニューを持ってきてください。" },
    { "speaker": "Waiter", "arabic": "مَاذَا تُرِيدُ يَا رَاشِد؟", "japanese": "ラシード様、何になさいますか？" },
    { "speaker": "Rashid", "arabic": "أَنَا أُرِيدُ بَعْضَ قِطَعِ الدَّجَاجِ الْمَشْوِيِّ.", "japanese": "私はグリルチキンをいくつか欲しいです。" },
    { "speaker": "Waiter", "arabic": "وَأَنْتَ مَاذَا تُرِيدُ يَا أَحْمَد؟", "japanese": "アハメド様、あなたは何になさいますか？" },
    { "speaker": "Ahmed", "arabic": "وَأَنَا أُرِيدُ بَعْضَ شَرَائِحِ اللَّحْمِ بِالْإِضَافَةِ إِلَى الْخُبْزِ الطَّازَجِ وَالشُّورَبَةِ وَالسَّلَطَةِ.", "japanese": "私はステーキ（肉のスライス）と、それに加えて焼きたてのパン、スープ、サラダが欲しいです。" },
    { "speaker": "Waiter", "arabic": "هَلْ أُحْضِرُ لَكُمَا شَيْئًا مِنَ الْمَشْرُوبَاتِ؟", "japanese": "何かお飲み物をお持ちしましょうか？" },
    { "speaker": "Rashid", "arabic": "نَعَمْ، أَنَا أُرِيدُ عَصِيرَ الْبُرْتُقَالِ.", "japanese": "はい、私はオレンジジュースをお願いします。" },
    { "speaker": "Ahmed", "arabic": "أَنَا أُرِيدُ كُوبًا مِنَ الْقَهْوَةِ.", "japanese": "私はコーヒーを一杯お願いします。" },
    { "speaker": "Rashid", "arabic": "عُذْرًا، كَمِ الْحِسَابُ مِنْ فَضْلِكَ؟", "japanese": "すみません、お会計はいくらですか？" },
    { "speaker": "Waiter", "arabic": "تَفَضَّلِ الْفَاتُورَةَ.", "japanese": "請求書をどうぞ。" },
    { "speaker": "Rashid", "arabic": "تَفَضَّلِ النُّقُودَ.", "japanese": "お金をどうぞ。" },
    { "speaker": "Waiter", "arabic": "شُكْرًا لَكَ، مَعَ السَّلَامَةِ.", "japanese": "ありがとうございます、さようなら。" }
  ],
  "vocabList": [
    { "word": "مَطْعَم", "meaning": "レストラン" },
    { "word": "غَدَاء", "meaning": "昼食（ランチ）" },
    { "word": "قَائِمَة الطَّعَام", "meaning": "メニュー" },
    { "word": "دَجَاج مَشْوِيّ", "meaning": "グリルチキン（焼き鳥）" },
    { "word": "لَحْم", "meaning": "肉" },
    { "word": "حِسَاب", "meaning": "会計／勘定" },
    { "word": "فَاتُورَة", "meaning": "請求書／レシート" }
  ],
  "questions": [
    { "id": 20011, "type": "listening", "text": "アハメドが注文した飲み物は何ですか？", "options": ["オレンジジュース", "水", "コーヒー", "お茶"], "correctIndex": 2, "explanation": "アハメドは「私はコーヒーを一杯欲しいです（أَنَا أُرِيدُ كُوبًا مِنَ الْقَهْوَةِ）」と注文しました。オレンジジュースはラシードの注文です。" },
    { "id": 20012, "type": "listening", "text": "レストランはどこにありますか？", "options": ["市場の中", "地下鉄駅の近く", "空港の隣", "アハメドの家の近く"], "correctIndex": 1, "explanation": "ラシードは「地下鉄駅の近くにあるレストランを知っている（أَعْرِفُ مَطْعَمًا قَرِيبًا مِنْ مَحَطَّةِ الْمِتْرُو）」と提案しました。" },
    { "id": 20013, "type": "listening", "text": "アハメドが肉料理と一緒に頼んだものは何ですか？", "options": ["パン、スープ、サラダ", "ライスと豆", "フライドポテト", "デザート"], "correctIndex": 0, "explanation": "アハメドは「パン、スープ、サラダに加えて（بِالْإِضَافَةِ إِلَى الْخُبْزِ ... وَالشُّورَبَةِ وَالسَّلَطَةِ）」と言っています。" },
    { "id": 20014, "type": "grammar_basic", "text": "レストランで「メニュー」を頼むときに使う単語は？", "options": ["الْفَاتُورَة (al-fātūra)", "الْحِسَاب (al-ḥisāb)", "قَائِمَة الطَّعَام (qā'ima aṭ-ṭaʿām)", "الْمَشْرُوبَات (al-mashrūbāt)"], "correctIndex": 2, "explanation": "メニューは「قَائِمَة الطَّعَام」です。الفاتورةは請求書、الحسابは会計を指します。" },
    { "id": 20015, "type": "grammar_basic", "text": "食事を終えて会計をお願いする時のフレーズとして正しいものは？", "options": ["مَسَاءُ الْخَيْرِ", "كَيْفَ حَالُكَ؟", "كَمِ الْحِسَابُ مِنْ فَضْلِكَ؟", "أَنَا جَائِعٌ جِدًّا"], "correctIndex": 2, "explanation": "「お会計はいくらですか？」は「كَمِ الْحِسَابُ مِنْ فَضْلِكَ؟」と言います。" }
  ]
},
{
  "id": 2002,
  ...
  "category": "買い物",
  "title": "市場での野菜と果物の買い物",
  "videoUrl": "https://www.youtube.com/watch?v=t13K6g6c_U8",
  "contentPlain": "الزبون: السلام عليكم.\nالبائع: وعليكم السلام. كيف حالك؟\nالزبون: أنا بخير والحمد لله. هل لديك خضراوات طازجة؟\nالبائع: نعم، لدي الكثير من الخضراوات الطازجة مثل الطماطم والخيار والجزر وأيضا الباذنجان.\nالزبون: أريد كيلوغراما من الطماطم وكيلوغراما من الخيار.\nالبائع: هل تريد شيئا من الفاكهة؟\nالزبون: نعم، أريد كيلوغراما من الموز وكيلوغراما من التفاح.\nالزبون: كم الحساب من فضلك؟\nالبائع: تفضل الفاتورة. الطماطم ثلاثة دراهم، الخيار أربعة دراهم، الموز خمسة دراهم، التفاح درهم.\nالزبون: تفضل النقود.\nالبائع: تفضل الفاكهة والخضراوات وباقي النقود.\nالزبون: شكرا لك.\nالبائع: عفوا، على الرحب والسعة. إلى اللقاء.\nالزبون: إلى اللقاء.",
  "contentVoweled": "الزَّبُون: السَّلَامُ عَلَيْكُم.\nالْبَائِع: وَعَلَيْكُمُ السَّلَام. كَيْفَ حَالُكَ؟\nالزَّبُون: أَنَا بِخَيْرٍ وَالْحَمْدُ لِلَّهِ. هَلْ لَدَيْكَ خَضْرَاوَاتٌ طَازَجَةٌ؟\nالْبَائِع: نَعَم، لَدَيَّ الْكَثِيرُ مِنَ الْخَضْرَاوَاتِ الطَّازَجَةِ مِثْلَ الطَّمَاطِمِ وَالْخِيَارِ وَالْجَزَرِ وَأَيْضًا الْبَاذِنْجَان.\nالزَّبُون: أُرِيدُ كِيلُوغْرَامًا مِنَ الطَّمَاطِمِ وَكِيلُوغْرَامًا مِنَ الْخِيَارِ.\nالْبَائِع: هَلْ تُرِيدُ شَيْئًا مِنَ الْفَاكِهَةِ؟\nالزَّبُون: نَعَم، أُرِيدُ كِيلُوغْرَامًا مِنَ الْمَوْزِ وَكِيلُوغْرَامًا مِنَ التُّفَّاحِ.\nالزَّبُون: كَمِ الْحِسَابُ مِنْ فَضْلِكَ؟\nالْبَائِع: تَفَضَّلِ الْفَاتُورَةَ. الطَّمَاطِم ثَلَاثَةُ دَرَاهِم، الْخِيَار أَرْبَعَةُ دَرَاهِم، الْمَوْز خَمْسَةُ دَرَاهِم، التُّفَّاح دِرْهَم.\nالزَّبُون: تَفَضَّلِ النُّقُودَ.\nالْبَائِع: تَفَضَّلِ الْفَاكِهَةَ وَالْخَضْرَاوَاتِ وَبَاقِيَ النُّقُودِ.\nالزَّبُون: شُكْرًا لَكَ.\nالْبَائِع: عَفْوًا، عَلَى الرُّحْبِ وَالسَّعَةِ. إِلَى اللِّقَاءِ.\nالزَّبُون: إِلَى اللِّقَاءِ.",
  "sentences": [
    { "speaker": "Customer", "arabic": "السَّلَامُ عَلَيْكُم.", "japanese": "こんにちは。" },
    { "speaker": "Seller", "arabic": "وَعَلَيْكُمُ السَّلَام. كَيْفَ حَالُكَ؟", "japanese": "こんにちは。お元気ですか？" },
    { "speaker": "Customer", "arabic": "أَنَا بِخَيْرٍ وَالْحَمْدُ لِلَّهِ. هَلْ لَدَيْكَ خَضْرَاوَاتٌ طَازَجَةٌ؟", "japanese": "元気です、おかげさまで。新鮮な野菜はありますか？" },
    { "speaker": "Seller", "arabic": "نَعَم، لَدَيَّ الْكَثِيرُ مِنَ الْخَضْرَاوَاتِ الطَّازَجَةِ مِثْلَ الطَّمَاطِمِ وَالْخِيَارِ وَالْجَزَرِ وَأَيْضًا الْبَاذِنْجَان.", "japanese": "はい、トマト、きゅうり、人参、そしてナスのような新鮮な野菜がたくさんあります。" },
    { "speaker": "Customer", "arabic": "أُرِيدُ كِيلُوغْرَامًا مِنَ الطَّمَاطِمِ وَكِيلُوغْرَامًا مِنَ الْخِيَارِ.", "japanese": "トマトを1キロ、きゅうりを1キロください。" },
    { "speaker": "Seller", "arabic": "هَلْ تُرِيدُ شَيْئًا مِنَ الْفَاكِهَةِ؟", "japanese": "果物は何か要りますか？" },
    { "speaker": "Customer", "arabic": "نَعَم، أُرِيدُ كِيلُوغْرَامًا مِنَ الْمَوْزِ وَكِيلُوغْرَامًا مِنَ التُّفَّاحِ.", "japanese": "はい、バナナを1キロ、リンゴを1キロください。" },
    { "speaker": "Customer", "arabic": "كَمِ الْحِسَابُ مِنْ فَضْلِكَ؟", "japanese": "お会計はいくらですか？" },
    { "speaker": "Seller", "arabic": "تَفَضَّلِ الْفَاتُورَةَ. الطَّمَاطِم ثَلَاثَةُ دَرَاهِم، الْخِيَار أَرْبَعَةُ دَرَاهِم، الْمَوْز خَمْسَةُ دَرَاهِم، التُّفَّاح دِرْهَم.", "japanese": "請求書をどうぞ。トマトは3ディルハム、きゅうりは4ディルハム、バナナは5ディルハム、リンゴは1ディルハムです。" },
    { "speaker": "Customer", "arabic": "تَفَضَّلِ النُّقُودَ.", "japanese": "お金をどうぞ。" },
    { "speaker": "Seller", "arabic": "تَفَضَّلِ الْفَاكِهَةَ وَالْخَضْرَاوَاتِ وَبَاقِيَ النُّقُودِ.", "japanese": "果物と野菜、そしてお釣りをどうぞ。" },
    { "speaker": "Customer", "arabic": "شُكْرًا لَكَ.", "japanese": "ありがとう。" },
    { "speaker": "Seller", "arabic": "عَفْوًا، عَلَى الرُّحْبِ وَالسَّعَةِ. إِلَى اللِّقَاءِ.", "japanese": "どういたしまして。さようなら。" },
    { "speaker": "Customer", "arabic": "إِلَى اللِّقَاءِ.", "japanese": "さようなら。" }
  ],
  "vocabList": [
    { "word": "خَضْرَاوَات", "meaning": "野菜" },
    { "word": "فَاكِهَة", "meaning": "果物" },
    { "word": "طَازَجَة", "meaning": "新鮮な" },
    { "word": "طَمَاطِم", "meaning": "トマト" },
    { "word": "خِيَار", "meaning": "きゅうり" },
    { "word": "مَوْز", "meaning": "バナナ" },
    { "word": "تُفَّاح", "meaning": "リンゴ" },
    { "word": "نُقُود", "meaning": "お金／現金" }
  ],
  "questions": [
    { "id": 20021, "type": "listening", "text": "客が最初に注文したものは何ですか？", "options": ["トマトときゅうり", "人参とナス", "バナナとリンゴ", "トマトと人参"], "correctIndex": 0, "explanation": "客は「トマトを1キロ、きゅうりを1キロ欲しい（أُرِيدُ كِيلُوغْرَامًا مِنَ الطَّمَاطِمِ وَكِيلُوغْرَامًا مِنَ الْخِيَارِ）」と注文しました。" },
    { "id": 20022, "type": "listening", "text": "店にあると言及されたが、客が買わなかった野菜はどれですか？", "options": ["トマト", "きゅうり", "ナス", "バナナ"], "correctIndex": 2, "explanation": "店主は「人参とナス（والجزر وأيضا الباذنجان）」もあると言いましたが、客はこれらを注文しませんでした。" },
    { "id": 20023, "type": "listening", "text": "バナナ（الموز）の値段はいくらでしたか？", "options": ["3ディルハム", "4ディルハム", "5ディルハム", "1ディルハム"], "correctIndex": 2, "explanation": "店主は請求書の内訳で「バナナは5ディルハム（الْمَوْز خَمْسَةُ دَرَاهِم）」と言っています。" },
    { "id": 20024, "type": "grammar_basic", "text": "「新鮮な」を意味するアラビア語はどれですか？", "options": ["لَذِيذ (ladhīdh)", "طَازَج (ṭāzaj)", "كَبِير (kabīr)", "رَخِيص (rakhīṣ)"], "correctIndex": 1, "explanation": "「新鮮な」は「طَازَج (ṭāzaj)」です。ここでは女性形の「طَازَجَة (ṭāzaja)」が使われています。" },
    { "id": 20025, "type": "grammar_basic", "text": "お礼を言われた時の返事「どういたしまして」として正しい表現は？", "options": ["مَعَ السَّلَامَةِ", "عَفْوًا، عَلَى الرُّحْبِ وَالسَّعَةِ", "أَنَا بِخَيْرٍ", "تَفَضَّلِ النُّقُودَ"], "correctIndex": 1, "explanation": "「どういたしまして」の丁寧な表現は「عَفْوًا، عَلَى الرُّحْبِ وَالسَّعَةِ」です。" }
  ]
},
{
  "id": 2003,
  ...
  "category": "レストラン",
  "title": "レストランでの注文",
  "videoUrl": "https://www.youtube.com/watch?v=4140IYgbsYI",
  "contentPlain": "النادل: السلام عليكم.\nالزبون: وعليكم السلام.\nالنادل: أهلا وسهلا.\nالزبون: أهلا وسهلا.\nالنادل: هذه قائمة الطعام.\nالزبون: شكرا جزيلا. أريد أن أطلب الأرز مع اللحم والدجاج.\nالنادل: هل ترغب في أن تطلب سلطة؟\nالزبون: السلطة.. أريد السلطة العربية بالزيتون.\nالنادل: هل تفضل الشراب مع الطعام أم بعد الطعام؟\nالزبون: أنا أفضل الشراب قبل الطعام.\nالنادل: هل تحب الشراب البارد أم الساخن؟\nالزبون: أحب الشراب البارد.\nالنادل: لدينا عصير التفاح وعصير العنب وعصير الجزر.\nالزبون: هل لديكم عصير البرتقال؟\nالنادل: نعم لدينا عصير البرتقال أيضا.\nالزبون: إذا أنا أريد عصير البرتقال مع الثلج.\nالنادل: أي شيء آخر؟\nالزبون: شكرا جزيلا لك. تفضل.\nالزبون: بسم الله الرحمن الرحيم. الحمد لله. كم المطلوب؟\nالنادل: المطلوب ثلاثة وعشرون دولار.\nالزبون: هل من الممكن أن أدفع الحساب بالبطاقة الائتمانية؟\nالنادل: نعم من الممكن. تفضل.\nالزبون: شكرا لك.\nالنادل: شكرا.",
  "contentVoweled": "النَّادِلُ: السَّلَامُ عَلَيْكُمْ.\nالزَّبُونُ: وَعَلَيْكُمُ السَّلَامُ.\nالنَّادِلُ: أَهْلًا وَسَهْلًا.\nالزَّبُونُ: أَهْلًا وَسَهْلًا.\nالنَّادِلُ: هَذِهِ قَائِمَةُ الطَّعَامِ.\nالزَّبُونُ: شُكْرًا جَزِيلًا. أُرِيدُ أَنْ أَطْلُبَ الْأُرُزَّ مَعَ اللَّحْمِ وَالدَّجَاجِ.\nالنَّادِلُ: هَلْ تَرْغَبُ فِي أَنْ تَطْلُبَ سَلَطَةً؟\nالزَّبُونُ: السَّلَطَةُ.. أُرِيدُ السَّلَطَةَ الْعَرَبِيَّةَ بِالزَّيْتُونِ.\nالنَّادِلُ: هَلْ تُفَضِّلُ الشَّرَابَ مَعَ الطَّعَامِ أَمْ بَعْدَ الطَّعَامِ؟\nالزَّبُونُ: أَنَا أُفَضِّلُ الشَّرَابَ قَبْلَ الطَّعَامِ.\nالنَّادِلُ: هَلْ تُحِبُّ الشَّرَابَ الْبَارِدَ أَمِ السَّاخِنَ؟\nالزَّبُونُ: أُحِبُّ الشَّرَابَ الْبَارِدَ.\nالنَّادِلُ: لَدَيْنَا عَصِيرُ التُّفَّاحِ وَعَصِيرُ الْعِنَبِ وَعَصِيرُ الْجَزَرِ.\nالزَّبُونُ: هَلْ لَدَيْكُمْ عَصِيرُ الْبُرْتُقَالِ؟\nالنَّادِلُ: نَعَمْ لَدَيْنَا عَصِيرُ الْبُرْتُقَالِ أَيْضًا.\nالزَّبُونُ: إِذًا أَنَا أُرِيدُ عَصِيرَ الْبُرْتُقَالِ مَعَ الثَّلْجِ.\nالنَّادِلُ: أَيُّ شَيْءٍ آخَرَ؟\nالزَّبُونُ: شُكْرًا جَزِيلًا لَكَ. تَفَضَّلْ.\nالزَّبُونُ: بِسْمِ اللهِ الرَّحْمَنِ الرَّحِيمِ. الْحَمْدُ للهِ. كَمِ الْمَطْلُوبُ؟\nالنَّادِلُ: الْمَطْلُوبُ ثَلَاثَةٌ وَعِشْرُونَ دُولَارًا.\nالزَّبُونُ: هَلْ مِنَ الْمُمْكِنِ أَنْ أَدْفَعَ الْحِسَابَ بِالْبِطَاقَةِ الْائْتِمَانِيَّةِ؟\nالنَّادِلُ: نَعَمْ مِنَ الْمُمْكِنِ. تَفَضَّلْ.\nالزَّبُونُ: شُكْرًا لَكَ.\nالنَّادِلُ: شُكْرًا.",
  "sentences": [
    { "speaker": "Waiter", "arabic": "السَّلَامُ عَلَيْكُمْ.", "japanese": "こんにちは（平安あれ）。" },
    { "speaker": "Customer", "arabic": "وَعَلَيْكُمُ السَّلَامُ.", "japanese": "こんにちは。" },
    { "speaker": "Waiter", "arabic": "أَهْلًا وَسَهْلًا.", "japanese": "いらっしゃいませ。" },
    { "speaker": "Customer", "arabic": "أَهْلًا وَسَهْلًا.", "japanese": "こんにちは（応答）。" },
    { "speaker": "Waiter", "arabic": "هَذِهِ قَائِمَةُ الطَّعَامِ.", "japanese": "こちらがメニューです。" },
    { "speaker": "Customer", "arabic": "شُكْرًا جَزِيلًا. أُرِيدُ أَنْ أَطْلُبَ الْأُرُزَّ مَعَ اللَّحْمِ وَالدَّجَاجِ.", "japanese": "ありがとうございます。ご飯と、肉と鶏肉を注文したいです。" },
    { "speaker": "Waiter", "arabic": "هَلْ تَرْغَبُ فِي أَنْ تَطْلُبَ سَلَطَةً؟", "japanese": "サラダは注文されますか？" },
    { "speaker": "Customer", "arabic": "السَّلَطَةُ.. أُرِيدُ السَّلَطَةَ الْعَرَبِيَّةَ بِالزَّيْتُونِ.", "japanese": "サラダ…オリーブ入りのアラビックサラダが欲しいです。" },
    { "speaker": "Waiter", "arabic": "هَلْ تُفَضِّلُ الشَّرَابَ مَعَ الطَّعَامِ أَمْ بَعْدَ الطَّعَامِ؟", "japanese": "お飲み物は食事と一緒がいいですか、食後がいいですか？" },
    { "speaker": "Customer", "arabic": "أَنَا أُفَضِّلُ الشَّرَابَ قَبْلَ الطَّعَامِ.", "japanese": "飲み物は食事の「前」がいいです。" },
    { "speaker": "Waiter", "arabic": "هَلْ تُحِبُّ الشَّرَابَ الْبَارِدَ أَمِ السَّاخِنَ؟", "japanese": "冷たい飲み物と温かい飲み物、どちらが好きですか？" },
    { "speaker": "Customer", "arabic": "أُحِبُّ الشَّرَابَ الْبَارِدَ.", "japanese": "冷たい飲み物が好きです。" },
    { "speaker": "Waiter", "arabic": "لَدَيْنَا عَصِيرُ التُّفَّاحِ وَعَصِيرُ الْعِنَبِ وَعَصِيرُ الْجَزَرِ.", "japanese": "リンゴジュース、ブドウジュース、ニンジンジュースがあります。" },
    { "speaker": "Customer", "arabic": "هَلْ لَدَيْكُمْ عَصِيرُ الْبُرْتُقَالِ؟", "japanese": "オレンジジュースはありますか？" },
    { "speaker": "Waiter", "arabic": "نَعَمْ لَدَيْنَا عَصِيرُ الْبُرْتُقَالِ أَيْضًا.", "japanese": "はい、オレンジジュースもあります。" },
    { "speaker": "Customer", "arabic": "إِذًا أَنَا أُرِيدُ عَصِيرَ الْبُرْتُقَالِ مَعَ الثَّلْجِ.", "japanese": "それじゃあ、氷入りのオレンジジュースをください。" },
    { "speaker": "Waiter", "arabic": "أَيُّ شَيْءٍ آخَرَ؟", "japanese": "他には？" },
    { "speaker": "Customer", "arabic": "شُكْرًا جَزِيلًا لَكَ. تَفَضَّلْ.", "japanese": "どうもありがとう。どうぞ（メニューをお返しします／注文は以上です）。" },
    { "speaker": "Customer", "arabic": "بِسْمِ اللهِ الرَّحْمَنِ الرَّحِيمِ. الْحَمْدُ للهِ. كَمِ الْمَطْلُوبُ؟", "japanese": "（食事前後の言葉）。ごちそうさまでした。お会計はいくらですか？" },
    { "speaker": "Waiter", "arabic": "الْمَطْلُوبُ ثَلَاثَةٌ وَعِشْرُونَ دُولَارًا.", "japanese": "23ドルになります。" },
    { "speaker": "Customer", "arabic": "هَلْ مِنَ الْمُمْكِنِ أَنْ أَدْفَعَ الْحِسَابَ بِالْبِطَاقَةِ الْائْتِمَانِيَّةِ؟", "japanese": "クレジットカードで支払うことは可能ですか？" },
    { "speaker": "Waiter", "arabic": "نَعَمْ مِنَ الْمُمْكِنِ. تَفَضَّلْ.", "japanese": "はい、可能です。どうぞ。" },
    { "speaker": "Customer", "arabic": "شُكْرًا لَكَ.", "japanese": "ありがとう。" },
    { "speaker": "Waiter", "arabic": "شُكْرًا.", "japanese": "ありがとう。" }
  ],
  "vocabList": [
    { "word": "أُرِيدُ أَنْ أَطْلُب", "meaning": "注文したいです" },
    { "word": "دَجَاج", "meaning": "鶏肉" },
    { "word": "زَيْتُون", "meaning": "オリーブ" },
    { "word": "قَبْلَ", "meaning": "～の前" },
    { "word": "ثَلْج", "meaning": "氷" },
    { "word": "بِطَاقَة اِئْتِمَانِيَّة", "meaning": "クレジットカード" },
    { "word": "مَطْلُوب", "meaning": "請求額" }
  ],
  "questions": [
    { "id": 20031, "type": "listening", "text": "客は飲み物をいつ持ってきてほしいと言いましたか？", "options": ["食事の後", "食事の前", "食事と一緒", "食事が終わってから"], "correctIndex": 1, "explanation": "客は「أَنَا أُفَضِّلُ الشَّرَابَ قَبْلَ الطَّعَامِ（私は食事の『前』がいいです）」とはっきり答えています。" },
    { "id": 20032, "type": "listening", "text": "客が注文した飲み物はどのようものでしたか？", "options": ["温かいお茶", "氷なしのリンゴジュース", "氷入りのオレンジジュース", "ホットコーヒー"], "correctIndex": 2, "explanation": "客は「عَصِيرَ الْبُرْتُقَالِ مَعَ الثَّلْجِ（氷入りのオレンジジュース）」を注文しました。" },
    { "id": 20033, "type": "listening", "text": "支払い方法は何でしたか？", "options": ["現金", "クレジットカード", "小切手", "ツケ"], "correctIndex": 1, "explanation": "客は「بِالْبِطَاقَةِ الْائْتِمَانِيَّةِ（クレジットカードで）」支払えるか尋ね、店員は承諾しました。" },
    { "id": 20034, "type": "grammar_basic", "text": "「～の前」を意味する単語は？", "options": ["بَعْدَ", "مَعَ", "قَبْلَ", "فِي"], "correctIndex": 2, "explanation": "「قَبْلَ (qabla)」が「～の前」です。「بَعْدَ」は後、「مَعَ」は一緒、「فِي」は中を意味します。" },
    { "id": 20035, "type": "grammar_basic", "text": "「クレジットカード」をアラビア語で何と言いますか？", "options": ["الْفَاتُورَة", "الْحِسَاب", "الْبِطَاقَة الْائْتِمَانِيَّة", "النُّقُود"], "correctIndex": 2, "explanation": "クレジットカードは「الْبِطَاقَة الْائْتِمَانِيَّة」です。" }
  ]
},
{
  "id": 2004,
  "level": "中級",
  "category": "諺",
  "title": "アラブの諺：バラーキシュは家族に災いをもたらした",
  "videoUrl": "https://www.youtube.com/watch?v=AXomdtg-6jU",
  "contentPlain": "جنت على أهلها براقش\nتعود قصة المثل لكلبة كانت تسمى براقش.\nوكانت تعيش في قرية صغيرة تحرسها من اللصوص والأعداء.\nوكانت تنبح كلما اقترب عدوٌ لتحذر أهل القرية منه.\nفي إحدى المرات هاجم العدو القرية، فبدأت براقش بالنباح لتحذير أهل القرية ودعوتهم لمواجهة العدو.\nكان العدو أكثر قوة من أهل القرية، فهربوا واختبأوا في مغارة قريبة كبيرة، إلى أن يخرج العدو من قريتهم.\nبحث الأعداء عن أهل القرية بلا جدوى.\nوعندما همّوا بالخروج من القرية، نبحت الكلبة براقش فرحاً بخروجهم من قريتهم وسلامة أهل القرية.\nحاول صاحب الكلبة إسكاتها... إلا أن العدو انتبه على نباح الكلبة.\nوهاجم المغارة، وقَتَل كثيراً من أهل القرية وقتل الكلبة براقش.\nيُقال هذا المثل في من يجلب الهلاك أو الأذى لنفسه أو لأهله.",
  "contentVoweled": "جَنَتْ عَلَى أَهْلِهَا بَرَاقِشُ\nتَعُودُ قِصَّةُ الْمَثَلِ لِكَلْبَةٍ كَانَتْ تُسَمَّى بَرَاقِشَ.\nوَكَانَتْ تَعِيشُ فِي قَرْيَةٍ صَغِيرَةٍ تَحْرُسُهَا مِنَ اللُّصُوصِ وَالْأَعْدَاءِ.\nوَكَانَتْ تَنْبَحُ كُلَّمَا اقْتَرَبَ عَدُوٌّ لِتُحَذِّرَ أَهْلَ الْقَرْيَةِ مِنْهُ.\nفِي إِحْدَى الْمَرَّاتِ هَاجَمَ الْعَدُوُّ الْقَرْيَةَ، فَبَدَأَتْ بَرَاقِشُ بِالنُّبَاحِ لِتُحَذِّيرِ أَهْلِ الْقَرْيَةِ وَدَعْوَتِهِمْ لِمُوَاجَهَةِ الْعَدُوِّ.\nكَانَ الْعَدُوُّ أَكْثَرَ قُوَّةً مِنْ أَهْلِ الْقَرْيَةِ، فَهَرَبُوا وَاخْتَبَأُوا فِي مَغَارَةٍ قَرِيبَةٍ كَبِيرَةٍ، إِلَى أَنْ يَخْرُجَ الْعَدُوُّ مِنْ قَرْيَتِهِمْ.\nبَحَثَ الْأَعْدَاءُ عَنْ أَهْلِ الْقَرْيَةِ بِلَا جَدْوَى.\nوَعِنْدَمَا هَمُّوا بِالْخُرُوجِ مِنَ الْقَرْيَةِ، نَبَحَتِ الْكَلْبَةُ بَرَاقِشُ فَرَحًا بِخُرُوجِهِمْ مِنْ قَرْيَتِهِمْ وَسَلَامَةِ أَهْلِ الْقَرْيَةِ.\nحَاوَلَ صَاحِبُ الْكَلْبَةِ إِسْكَاتَهَا... إِلَّا أَنَّ الْعَدُوَّ انْتَبَهَ عَلَى نُبَاحِ الْكَلْبَةِ.\nوَهَاجَمَ الْمَغَارَةَ، وَقَتَلَ كَثِيرًا مِنْ أَهْلِ الْقَرْيَةِ وَقَتَلَ الْكَلْبَةَ بَرَاقِشَ.\nيُقَالُ هَذَا الْمَثَلُ فِي مَنْ يَجْلِبُ الْهَلَاكَ أَوِ الْأَذَى لِنَفْسِهِ أَوْ لِأَهْلِهِ.",
  "sentences": [
    { "speaker": "Narrator", "arabic": "جَنَتْ عَلَى أَهْلِهَا بَرَاقِشُ", "japanese": "バラーキシュは家族に災いをもたらした（諺）" },
    { "speaker": "Narrator", "arabic": "تَعُودُ قِصَّةُ الْمَثَلِ لِكَلْبَةٍ كَانَتْ تُسَمَّى بَرَاقِشَ.", "japanese": "この諺の物語は、バラーキシュと呼ばれた一匹のメス犬に由来します。" },
    { "speaker": "Narrator", "arabic": "وَكَانَتْ تَعِيشُ فِي قَرْيَةٍ صَغِيرَةٍ تَحْرُسُهَا مِنَ اللُّصُوصِ وَالْأَعْدَاءِ.", "japanese": "彼女は小さな村に住み、泥棒や敵から村を守っていました。" },
    { "speaker": "Narrator", "arabic": "وَكَانَتْ تَنْبَحُ كُلَّمَا اقْتَرَبَ عَدُوٌّ لِتُحَذِّرَ أَهْلَ الْقَرْيَةِ مِنْهُ.", "japanese": "そして敵が近づくたびに吠えて、村人たちに警告していました。" },
    { "speaker": "Narrator", "arabic": "فِي إِحْدَى الْمَرَّاتِ هَاجَمَ الْعَدُوُّ الْقَرْيَةَ، فَبَدَأَتْ بَرَاقِشُ بِالنُّبَاحِ لِتُحَذِّيرِ أَهْلِ الْقَرْيَةِ وَدَعْوَتِهِمْ لِمُوَاجَهَةِ الْعَدُوِّ.", "japanese": "ある時、敵が村を襲撃しました。そこでバラーキシュは村人に警告し、敵に立ち向かうよう促すために吠え始めました。" },
    { "speaker": "Narrator", "arabic": "كَانَ الْعَدُوُّ أَكْثَرَ قُوَّةً مِنْ أَهْلِ الْقَرْيَةِ، فَهَرَبُوا وَاخْتَبَأُوا فِي مَغَارَةٍ قَرِيبَةٍ كَبِيرَةٍ، إِلَى أَنْ يَخْرُجَ الْعَدُوُّ مِنْ قَرْيَتِهِمْ.", "japanese": "敵は村人たちよりも強かったため、彼らは逃げ出し、敵が村を出ていくまで近くの大きな洞窟に隠れました。" },
    { "speaker": "Narrator", "arabic": "بَحَثَ الْأَعْدَاءُ عَنْ أَهْلِ الْقَرْيَةِ بِلَا جَدْوَى.", "japanese": "敵は村人たちを探しましたが見つかりませんでした。" },
    { "speaker": "Narrator", "arabic": "وَعِنْدَمَا هَمُّوا بِالْخُرُوجِ مِنَ الْقَرْيَةِ، نَبَحَتِ الْكَلْبَةُ بَرَاقِشُ فَرَحًا بِخُرُوجِهِمْ مِنْ قَرْيَتِهِمْ وَسَلَامَةِ أَهْلِ الْقَرْيَةِ.", "japanese": "そして敵が村から出ようとした時、バラーキシュは彼らが出ていくことと村人の無事を喜んで吠えてしまいました。" },
    { "speaker": "Narrator", "arabic": "حَاوَلَ صَاحِبُ الْكَلْبَةِ إِسْكَاتَهَا... إِلَّا أَنَّ الْعَدُوَّ انْتَبَهَ عَلَى نُبَاحِ الْكَلْبَةِ.", "japanese": "飼い主は彼女を静かにさせようとしましたが、敵はその鳴き声に気づいてしまいました。" },
    { "speaker": "Narrator", "arabic": "وَهَاجَمَ الْمَغَارَةَ، وَقَتَلَ كَثِيرًا مِنْ أَهْلِ الْقَرْيَةِ وَقَتَلَ الْكَلْبَةَ بَرَاقِشَ.", "japanese": "敵は洞窟を襲撃し、多くの村人と犬のバラーキシュを殺しました。" },
    { "speaker": "Narrator", "arabic": "يُقَالُ هَذَا الْمَثَلُ فِي مَنْ يَجْلِبُ الْهَلَاكَ أَوِ الْأَذَى لِنَفْسِهِ أَوْ لِأَهْلِهِ.", "japanese": "この諺は、自分自身や身内に破滅や害悪を招いてしまう人に対して言われます。" }
  ],
  "vocabList": [
    { "word": "مَثَل", "meaning": "諺（ことわざ）、例" },
    { "word": "كَلْبَة", "meaning": "メス犬" },
    { "word": "عَدُوّ", "meaning": "敵" },
    { "word": "نَبَحَ", "meaning": "（犬が）吠える" },
    { "word": "مَغَارَة", "meaning": "洞窟" },
    { "word": "بَحَثَ عَنْ", "meaning": "～を探す" },
    { "word": "إِسْكَات", "meaning": "黙らせること" },
    { "word": "أَذَى", "meaning": "害、災い" }
  ],
  "questions": [
    {
      "id": 20041,
      "type": "listening",
      "text": "لِمَاذَا اخْتَبَأَ أَهْلُ الْقَرْيَةِ فِي الْمَغَارَةِ؟",
      "options": [
        "لِمُهَاجَمَةِ الْعَدُوِّ",
        "لِأَنَّ الْعَدُوَّ كَانَ أَقْوَى مِنْهُمْ",
        "لِلْبَحْثِ عَنْ بَرَاقِشَ",
        "لِأَنَّ اللَّيْلَ قَدْ حَلَّ"
      ],
      "correctIndex": 1,
      "explanation": "質問は「なぜ村人たちは洞窟に隠れたのですか？」。正解は「敵が彼らより強かったから（لِأَنَّ الْعَدُوَّ كَانَ أَقْوَى مِنْهُمْ）」です。"
    },
    {
      "id": 20042,
      "type": "listening",
      "text": "مَاذَا فَعَلَتْ بَرَاقِشُ عِنْدَمَا هَمَّ الْعَدُوُّ بِالْخُرُوجِ؟",
      "options": [
        "لَحِقَتْ بِالْعَدُوِّ",
        "بَقِيَتْ صَامِتَةً",
        "نَبَحَتْ فَرَحًا",
        "نَامَتْ"
      ],
      "correctIndex": 2,
      "explanation": "質問は「敵が出ようとした時、バラーキシュは何をしましたか？」。正解は「喜んで吠えた（نَبَحَتْ فَرَحًا）」です。"
    },
    {
      "id": 20043,
      "type": "listening",
      "text": "كَيْفَ كَانَتْ نِهَايَةُ الْقِصَّةِ؟",
      "options": [
        "هَرَبَ الْعَدُوُّ",
        "نَجَا الْأَهْلُ وَمَاتَتِ الْكَلْبَةُ فَقَطْ",
        "قُتِلَ كَثِيرٌ مِنَ الْأَهْلِ وَبَرَاقِشُ",
        "أَصْبَحَ الْعَدُوُّ وَالْأَهْلُ أَصْدِقَاءَ"
      ],
      "correctIndex": 2,
      "explanation": "質問は「物語の結末はどうなりましたか？」。正解は「多くの村人とバラーキシュが殺された（قُتِلَ كَثِيرٌ مِنَ الْأَهْلِ وَبَرَاقِشُ）」です。"
    },
    {
      "id": 20044,
      "type": "grammar_basic",
      "text": "اخْتَبَأَ النَّاسُ فِي مَكَانٍ كَبِيرٍ فِي الْجَبَلِ. مَا اسْمُ هَذَا الْمَكَانِ؟",
      "options": [
        "قَرْيَة",
        "مَغَارَة",
        "جَبَل",
      ...
      "correctIndex": 1,
      "explanation": "質問は「人々は山の中の大きな場所に隠れました。この場所の名前は何ですか？」。正解は「洞窟（مَغَارَة）」です。"
    },
    {
      "id": 20045,
      "type": "grammar_basic",
      "text": "فِيمَنْ يُضْرَبُ هَذَا الْمَثَلُ؟",
      "options": [
        "مَنْ هَزَمَ الْعَدُوَّ بِشَجَاعَةٍ",
        "مَنْ حَمَى الْقَرْيَةَ",
        "مَنْ جَلَبَ الْهَلَاكَ لِنَفْسِهِ أَوْ لِأَهْلِهِ",
        "مَنْ يُحِبُّ الْكِلَابَ"
      ],
      "correctIndex": 2,
      "explanation": "質問は「この諺は誰に対して使われますか？」。正解は「自分や家族に破滅を招いた人（مَنْ جَلَبَ الْهَلَاكَ لِنَفْسِهِ أَوْ لِأَهْلِهِ）」です。"
    }
  ]
},
{
  ...
  "category": "買い物",
  "title": "市場での買い物",
  "videoUrl": "https://www.youtube.com/watch?v=PS52GCLAIu0",
  "contentPlain": "في صباح جميل استيقظت مبكراً.\nغسلت وجهي ولبست ملابسي ثم شربت فنجان قهوة سريع.\nبعد ذلك قررت أن أذهب إلى السوق لأشتري بعض الطعام.\nعند وصولي رأيت السوق مزدحماً.\nالبائعون ينادون تفاح موز برتقال وكان الناس يتحركون في كل مكان.\nاقتربت من بائع الخضار قلت له كم ثمن الطماطم؟\nقال أربعة جنيهات للكيلو فاشتريت طماطم وخيار.\nثم مررت على بائع الخبز وقلت من فضلك رغيفان.\nابتسم وأعطاني خبزاً طازجاً.\nبعد ذلك ذهبت إلى بائع الفاكهة اشتريت بعض الموز والتفاح.\nثم قررت أن أشتري أيضاً برتقالاً للعصير.\nوضعت كل شيء في حقيبتي وشعرت بالسعادة لأنني وجدت ما أحتاجه.\nثم رجعت إلى البيت أفكر في الغداء.",
  "contentVoweled": "فِي صَبَاحٍ جَمِيلٍ اسْتَيْقَظْتُ مُبَكِّرًا.\nغَسَلْتُ وَجْهِي وَلَبِسْتُ مَلَابِسِي ثُمَّ شَرِبْتُ فِنْجَانَ قَهْوَةٍ سَرِيعٍ.\nبَعْدَ ذَلِكَ قَرَّرْتُ أَنْ أَذْهَبَ إِلَى السُّوقِ لِأَشْتَرِيَ بَعْضَ الطَّعَامِ.\nعِنْدَ وُصُولِي رَأَيْتُ السُّوقَ مُزْدَحِمًا.\nالْبَائِعُونَ يُنَادُونَ: تُفَّاح، مَوْز، بُرْتُقَال، وَكَانَ النَّاسُ يَتَحَرَّكُونَ فِي كُلِّ مَكَانٍ.\nاقْتَرَبْتُ مِنْ بَائِعِ الْخُضَارِ قُلْتُ لَهُ: كَمْ ثَمَنُ الطَّمَاطِمِ؟\nقَالَ: أَرْبَعَةُ جُنَيْهَاتٍ لِلْكِيلُو. فَاشْتَرَيْتُ طَمَاطِمَ وَخِيَار.\nثُمَّ مَرَرْتُ عَلَى بَائِعِ الْخُبْزِ وَقُلْتُ: مِنْ فَضْلِكَ رَغِيفَانِ.\nابْتَسَمَ وَأَعْطَانِي خُبْزًا طَازَجًا.\nبَعْدَ ذَلِكَ ذَهَبْتُ إِلَى بَائِعِ الْفَاكِهَةِ اشْتَرَيْتُ بَعْضَ الْمَوْزِ وَالتُّفَّاحِ.\nثُمَّ قَرَّرْتُ أَنْ أَشْتَرِيَ أَيْضًا بُرْتُقَالًا لِلْعَصِيرِ.\nوَضَعْتُ كُلَّ شَيْءٍ فِي حَقِيبَتِي وَشَعَرْتُ بِالسَّعَادَةِ لِأَنَّنِي وَجَدْتُ مَا أَحْتَاجُهُ.\nثُمَّ رَجَعْتُ إِلَى الْبَيْتِ أُفَكِّرُ فِي الْغَدَاءِ.",
  "sentences": [
    { "speaker": "Narrator", "arabic": "فِي صَبَاحٍ جَمِيلٍ اسْتَيْقَظْتُ مُبَكِّرًا. غَسَلْتُ وَجْهِي وَلَبِسْتُ مَلَابِسِي ثُمَّ شَرِبْتُ فِنْجَانَ قَهْوَةٍ سَرِيعٍ.", "japanese": "ある美しい朝、私は早く起きました。顔を洗い、服を着て、急いでコーヒーを一杯飲みました。" },
    { "speaker": "Narrator", "arabic": "بَعْدَ ذَلِكَ قَرَّرْتُ أَنْ أَذْهَبَ إِلَى السُّوقِ لِأَشْتَرِيَ بَعْضَ الطَّعَامِ.", "japanese": "その後、私は市場へ行って食べ物を買うことにしました。" },
    { "speaker": "Narrator", "arabic": "عِنْدَ وُصُولِي رَأَيْتُ السُّوقَ مُزْدَحِمًا. الْبَائِعُونَ يُنَادُونَ: تُفَّاح، مَوْز، بُرْتُقَال.", "japanese": "到着すると、市場は混雑していました。売り子たちが「リンゴ、バナナ、オレンジ」と叫んでいました。" },
    { "speaker": "Narrator", "arabic": "اقْتَرَبْتُ مِنْ بَائِعِ الْخُضَارِ قُلْتُ لَهُ: كَمْ ثَمَنُ الطَّمَاطِمِ؟ قَالَ: أَرْبَعَةُ جُنَيْهَاتٍ لِلْكِيلُو.", "japanese": "私は八百屋に近づき、「トマトはいくらですか？」と尋ねました。彼は「1キロ4ポンドだよ」と言いました。" },
    { "speaker": "Narrator", "arabic": "فَاشْتَرَيْتُ طَمَاطِمَ وَخِيَار. ثُمَّ مَرَرْتُ عَلَى بَائِعِ الْخُبْزِ وَقُلْتُ: مِنْ فَضْلِكَ رَغِيفَانِ.", "japanese": "私はトマトとキュウリを買いました。それからパン屋に立ち寄り、「パンを2つください」と言いました。" },
    { "speaker": "Narrator", "arabic": "ابْتَسَمَ وَأَعْطَانِي خُبْزًا طَازَجًا. بَعْدَ ذَلِكَ ذَهَبْتُ إِلَى بَائِعِ الْفَاكِهَةِ.", "japanese": "彼は微笑んで、焼きたてのパンをくれました。その後、果物屋へ行きました。" },
    { "speaker": "Narrator", "arabic": "اشْتَرَيْتُ بَعْضَ الْمَوْزِ وَالتُّفَّاحِ. ثُمَّ قَرَّرْتُ أَنْ أَشْتَرِيَ أَيْضًا بُرْتُقَالًا لِلْعَصِيرِ.", "japanese": "バナナとリンゴを買いました。そしてジュース用にオレンジも買うことにしました。" },
    { "speaker": "Narrator", "arabic": "وَضَعْتُ كُلَّ شَيْءٍ فِي حَقِيبَتِي وَشَعَرْتُ بِالسَّعَادَةِ لِأَنَّنِي وَجَدْتُ مَا أَحْتَاجُهُ.", "japanese": "私はすべてを鞄に入れ、必要なものが見つかったので幸せな気分になりました。" },
    { "speaker": "Narrator", "arabic": "ثُمَّ رَجَعْتُ إِلَى الْبَيْتِ أُفَكِّرُ فِي الْغَدَاءِ.", "japanese": "そして昼食のことを考えながら家に帰りました。" }
  ],
  "vocabList": [
    { "word": "اسْتَيْقَظَ", "meaning": "起きる、目覚める" },
    { "word": "مُبَكِّرًا", "meaning": "早く" },
    { "word": "سُوق", "meaning": "市場" },
    { "word": "مُزْدَحِم", "meaning": "混雑した" },
    { "word": "بَائِع", "meaning": "売り手、商人" },
    { "word": "خُضَار", "meaning": "野菜" },
    { "word": "ثَمَن", "meaning": "値段" },
    { "word": "طَازَج", "meaning": "新鮮な" }
  ],
  "questions": [
    {
      "id": 20051,
      "type": "listening",
      "text": "مَاذَا شَرِبَ الْمُتَحَدِّثُ فِي الصَّبَاحِ؟",
      "options": [
        "شَاي",
        "عَصِير",
        "قَهْوَة",
      ...
      "correctIndex": 2,
      "explanation": "質問は「話し手は朝に何を飲みましたか？」。正解は「コーヒー（قَهْوَة）」です。"
    },
    {
      "id": 20052,
      "type": "listening",
      "text": "كَيْفَ كَانَ حَالُ السُّوقِ؟",
      "options": [
        "هَادِئًا",
        "مُزْدَحِمًا",
        "مُغْلَقًا",
      ...
      "correctIndex": 1,
      "explanation": "質問は「市場の様子はどうでしたか？」。正解は「混雑していた（مُزْدَحِمًا）」です。"
    },
    {
      "id": 20053,
      "type": "listening",
      "text": "كَمْ كَانَ ثَمَنُ الطَّمَاطِمِ لِلْكِيلُو؟",
      "options": [
        "جُنَيْهٌ وَاحِدٌ",
        "خَمْسَةُ جُنَيْهَاتٍ",
        "ثَلَاثَةُ جُنَيْهَاتٍ",
        "أَرْبَعَةُ جُنَيْهَاتٍ"
      ],
      "correctIndex": 3,
      "explanation": "質問は「トマト1キロの値段はいくらでしたか？」。正解は「4ポンド（أَرْبَعَةُ جُنَيْهَاتٍ）」です。"
    },
    {
      "id": 20054,
      "type": "grammar_basic",
      "text": "مَا عَكْسُ كَلِمَةِ \"مُبَكِّرًا\"؟",
      "options": [
        "سَرِيعًا",
        "مُتَأَخِّرًا",
        "بَعِيدًا",
      ...
      "correctIndex": 1,
      "explanation": "質問は「『早く（mubakkiran）』の反対語は何ですか？」。正解は「遅く（mut'akhkhiran）」です。"
    },
    {
      "id": 20055,
      "type": "grammar_basic",
      "text": "لِمَاذَا شَعَرَ الْمُتَحَدِّثُ بِالسَّعَادَةِ؟",
      "options": [
        "لِأَنَّهُ شَرِبَ الْقَهْوَةَ",
        "لِأَنَّ الْجَوَّ كَانَ جَمِيلًا",
        "لِأَنَّهُ وَجَدَ مَا يَحْتَاجُهُ",
        "لِأَنَّهُ قَابَلَ صَدِيقًا"
      ],
      "correctIndex": 2,
      "explanation": "質問は「なぜ話し手は幸せを感じましたか？」。正解は「必要なものが見つかったから（لِأَنَّهُ وَجَدَ مَا يَحْتَاجُهُ）」です。"
    }
  ]
},
    ];