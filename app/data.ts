  ...
  // --- 71. 健康・文化 (Health) ---
   {
      ...
      // --- 72. 経済・未来 (Economy/Future) ---
      {
        ...
        // --- 73. 観光・経済 (Tourism & Economy) ---
      {
        id: 1083,
        level: "中級", // ★中級に変更
        category: "観光",
        title: "サウジアラビア、世界的な観光立国へ",
        contentPlain: "حققت المملكة العربية السعودية إنجازا تاريخيا في قطاع السياحة، حيث تجاوز عدد السياح 100 مليون سائح بنهاية عام 2023. وأكد وزير السياحة أن المملكة تستهدف الآن جذب 150 مليون سائح بحلول عام 2030. وقد أشاد صندوق النقد الدولي بهذه القفزات النوعية، مشيرا إلى أن مساهمة القطاع السياحي في الناتج المحلي الإجمالي بلغت 11.5%.",
        contentVoweled: "حَقَّقَتِ الْمَمْلَكَةُ الْعَرَبِيَّةُ السُّعُودِيَّةُ إِنْجَازًا تَارِيخِيًّا فِي قِطَاعِ السِّيَاحَةِ، حَيْثُ تَجَاوَزَ عَدَدُ السُّيَّاحِ 100 مِلْيُونِ سَائِحٍ بِنِهَايَةِ عَامِ 2023. وَأَكَّدَ وَزِيرُ السِّيَاحَةِ أَنَّ الْمَمْلَكَةَ تَسْتَهْدِفُ الْآنَ جَذْبَ 150 مِلْيُونِ سَائِحٍ بِحُلُولِ عَامِ 2030. وَقَدْ أَشَادَ صُنْدُوقُ النَّقْدِ الدَّوْلِيِّ بِهَذِهِ الْقَفْزَاتِ النَّوْعِيَّةِ، مُشِيرًا إِلَى أَنَّ مُسَاهَمَةَ الْقِطَاعِ السِّيَاحِيِّ فِي النَّاتِجِ الْمَحَلِّيِّ الْإِجْمَالِيِّ بَلَغَتْ 11.5%.",
        sentences: [
          {
            speaker: "記事",
            arabic: "حَقَّقَتِ الْمَمْلَكَةُ إِنْجَازًا تَارِيخِيًّا حَيْثُ تَجَاوَزَ عَدَدُ السُّيَّاحِ 100 مِلْيُونِ سَائِحٍ.",
            japanese: "王国は歴史的な偉業を達成し、観光客数は1億人を超えました。"
          },
          {
            speaker: "記事",
            arabic: "تَسْتَهْدِفُ الْمَمْلَكَةُ الْآنَ جَذْبَ 150 مِلْيُونِ سَائِحٍ بِحُلُولِ عَامِ 2030.",
            japanese: "王国は現在、2030年までに1億5000万人の観光客誘致を目指しています。"
          },
          {
            speaker: "記事",
            arabic: "بَلَغَتْ مُسَاهَمَةُ الْقِطَاعِ السِّيَاحِيِّ فِي النَّاتِجِ الْمَحَلِّيِّ 11.5%.",
            japanese: "観光セクターのGDP（国内総生産）への貢献度は11.5%に達しました。"
          }
        ],
        vocabList: [
          { word: "إِنْجَاز", meaning: "達成/偉業" },
          { word: "تَجَاوَزَ", meaning: "超える" },
          { word: "وَجْهَة", meaning: "目的地" },
          { word: "نَاتِج مَحَلِّي", meaning: "GDP" }
        ],
        questions: [
          {
            id: 10831,
            type: "reading",
            text: "観光客数は2023年末に何人を超えましたか？",
            options: ["5000万人", "1億人", "10億人", "200万人"],
            correctIndex: 1,
            explanation: "「100 مليون سائح (1億人の観光客)」と記述されています。"
          },
          {
            id: 10832,
            type: "reading", // ★この行を追加してください！
            text: "2030年の新しい目標人数は？",
            options: ["1億人", "1.5億人", "3億人", "変わらない"],
            correctIndex: 1,
            explanation: "「جذب 150 مليون سائح (1億5000万人の誘致)」を目指しています。"
          },
          {
            id: 10833,
            type: "reading", // ★この行を追加してください！
            text: "観光業のGDPへの貢献度は何%になりましたか？",
            options: ["5%", "10%", "11.5%", "20%"],
            correctIndex: 2,
            explanation: "「بلغت 11.5% (11.5%に達した)」とあります。"
          }
        ]
      },

      // --- 74. テクノロジー (Technology & AI) ---
      {
        id: 1084,
        level: "中級", // ★中級に変更
        category: "テクノロジー",
        title: "サウジアラビア、AI分野で世界トップへ",
        contentPlain: "حققت المملكة العربية السعودية المركز الأول عالمياً في مسابقة الذكاء الاصطناعي العالمية للشباب لعام 2024، حيث حصد طلابها 22 ميدالية متفوقين على منافسين من دول متقدمة. ويعكس هذا الإنجاز جهود الهيئة السعودية للبيانات والذكاء الاصطناعي (سدايا). كما احتلت المملكة المرتبة الثانية عالمياً في الوعي المجتمعي بتقنيات الذكاء الاصطناعي.",
        contentVoweled: "حَقَّقَتِ الْمَمْلَكَةُ الْعَرَبِيَّةُ السُّعُودِيَّةُ الْمَرْكَزَ الْأَوَّلَ عَالَمِيًّا فِي مُسَابَقَةِ الذَّكَاءِ الِاصْطِنَاعِيِّ الْعَالَمِيَّةِ لِلشَّبَابِ لِعَامِ 2024، حَيْثُ حَصَدَ طُلَّابُهَا 22 مِيدَالِيَّةً مُتَفَوِّقِينَ عَلَى مُنَافِسِينَ مِنْ دُوَلٍ مُتَقَدِّمَةٍ. وَيَعْكِسُ هَذَا الْإِنْجَازُ جُهُودَ الْهَيْئَةِ السُّعُودِيَّةِ لِلْبَيَانَاتِ وَالذَّكَاءِ الِاصْطِنَاعِيِّ (سَدَايَا). كَمَا احْتَلَّتِ الْمَمْلَكَةُ الْمَرْتَبَةَ الثَّانِيَةَ عَالَمِيًّا فِي الْوَعْيِ الْمُجْتَمَعِيِّ بِتِقْنِيَّاتِ الذَّكَاءِ الِاصْطِنَاعِيِّ.",
        sentences: [
          {
            speaker: "記事",
            arabic: "حَقَّقَتِ الْمَمْلَكَةُ الْمَرْكَزَ الْأَوَّلَ عَالَمِيًّا فِي مُسَابَقَةِ الذَّكَاءِ الِاصْطِنَاعِيِّ.",
            japanese: "王国は世界AIコンペティションで世界第1位を獲得しました。"
          },
          {
            speaker: "記事",
            arabic: "حَصَدَ طُلَّابُهَا 22 مِيدَالِيَّةً مُتَفَوِّقِينَ عَلَى مُنَافِسِينَ آخَرِينَ.",
            japanese: "学生たちは他のライバルを上回り、22個のメダルを獲得しました。"
          },
          {
            speaker: "記事",
            arabic: "احْتَلَّتِ الْمَمْلَكَةُ الْمَرْتَبَةَ الثَّانِيَةَ عَالَمِيًّا فِي الْوَعْيِ الْمُجْتَمَعِيِّ بِالـ AI.",
            japanese: "王国はAIに対する社会的意識において世界第2位を占めました。"
          }
        ],
        vocabList: [
          { word: "ذَكَاء اِصْطِنَاعِيّ", meaning: "AI (人工知能)" },
          { word: "مِيدَالِيَّة", meaning: "メダル" },
          { word: "وَعْي", meaning: "意識" },
          { word: "مُتَفَوِّق", meaning: "優秀な/勝る" }
        ],
        questions: [
          {
            id: 10841,
            type: "reading",
            text: "サウジの学生は何個のメダルを取りましたか？",
            options: ["10個", "22個", "50個", "100個"],
            correctIndex: 1,
            explanation: "「22 ميدالية (22個のメダル)」と書かれています。"
          },
          {
            id: 10842,
            type: "reading",
            text: "この成果に関わっている政府機関は？",
            options: ["SDAIA (スダーヤ)", "NEOM (ネオム)", "STC", "厚生省"],
            correctIndex: 0,
            explanation: "「الهيئة السعودية للبيانات والذكاء الاصطناعي (سدايا)」の努力であると記述があります。"
          },
          {
            id: 10843,
            type: "reading",
            text: "AIに対する「社会的な意識」で、サウジは何位でしたか？",
            options: ["1位", "2位", "3位", "10位"],
            correctIndex: 1,
            explanation: "「المرتبة الثانية (第2位)」とあります。"
          }
        ]
      },

      // --- 75. 宇宙・科学 (Space & Science) ---
      {
        id: 1085,
        level: "中級", // ★中級に変更
        category: "科学",
        title: "リヤドで宇宙ゴミ対策会議を開催",
        contentPlain: "استضافت الرياض مؤتمرا عالميا لمناقشة تحديات \"الحطام الفضائي\"، بتنظيم من وكالة الفضاء السعودية. يهدف المؤتمر إلى حماية الأقمار الصناعية من الخطر الكبير الذي يشكله الحطام. كما وقعت الوكالة اتفاقية لإنشاء \"مركز مستقبل الفضاء\" في المملكة، لتعزيز الابتكار في هذا القطاع المهم.",
        contentVoweled: "اِسْتَضَافَتِ الرِّيَاضُ مُؤْتَمَرًا عَالَمِيًّا لِمُنَاقَشَةِ تَحَدِّيَاتِ \"الْحُطَامِ الْفَضَائِيِّ\"، بِتَنْظِيمٍ مِنْ وَكَالَةِ الْفَضَاءِ السُّعُودِيَّةِ. يَهْدِفُ الْمُؤْتَمَرُ إِلَى حِمَايَةِ الْأَقْمَارِ الصِّنَاعِيَّةِ مِنَ الْخَطَرِ الْكَبِيرِ الَّذِي يُشَكِّلُهُ الْحُطَامُ. كَمَا وَقَّعَتِ الْوَكَالَةُ اتِّفَاقِيَّةً لِإِنْشَاءِ \"مَرْكَزِ مُسْتَقْبَلِ الْفَضَاءِ\" فِي الْمَمْلَكَةِ، لِتَعْزِيزِ الِابْتِكَارِ فِي هَذَا الْقِطَاعِ الْمُهِمِّ.",
        sentences: [
          {
            speaker: "記事",
            arabic: "اِسْتَضَافَتِ الرِّيَاضُ مُؤْتَمَرًا لِمُنَاقَشَةِ تَحَدِّيَاتِ الْحُطَامِ الْفَضَائِيِّ.",
            japanese: "リヤドは宇宙ゴミの課題を議論するための会議を主催しました。"
          },
          {
            speaker: "記事",
            arabic: "يُشَكِّلُ الْحُطَامُ خَطَرًا كَبِيرًا عَلَى الْأَقْمَارِ الصِّنَاعِيَّةِ.",
            japanese: "デブリ（ゴミ）は人工衛星にとって大きな危険となっています。"
          },
          {
            speaker: "記事",
            arabic: "وَقَّعَتِ الْوَكَالَةُ اتِّفَاقِيَّةً لِإِنْشَاءِ مَرْكَزِ مُسْتَقْبَلِ الْفَضَاءِ.",
            japanese: "同庁は「宇宙未来センター」を設立する協定に署名しました。"
          }
        ],
        vocabList: [
          { word: "حُطَام", meaning: "破片/デブリ" },
          { word: "فَضَاء", meaning: "宇宙" },
          { word: "أَقْمَار صِنَاعِيَّة", meaning: "人工衛星" },
          { word: "اِبْتِكَار", meaning: "イノベーション" }
        ],
        questions: [
          {
            id: 10851,
            type: "reading",
            text: "会議のテーマは何でしたか？",
            options: ["火星移住", "宇宙ゴミ (スペースデブリ)", "宇宙人の探索", "ロケット打ち上げ"],
            correctIndex: 1,
            explanation: "「تحديات الحطام الفضائي (宇宙ゴミの課題)」についてです。"
          },
          {
            id: 10852,
            type: "reading",
            text: "宇宙ゴミは何にとって危険ですか？",
            options: ["海", "人工衛星", "ビル", "動物"],
            correctIndex: 1,
            explanation: "「الأقمار الصناعية (人工衛星)」に対する危険について述べています。"
          },
          {
            id: 10853,
            type: "reading",
            text: "新しく設立されるセンターの名前は？",
            options: ["宇宙未来センター", "宇宙遊園地", "リヤド宇宙基地", "国際宇宙ステーション"],
            correctIndex: 0,
            explanation: "「مركز مستقبل الفضاء (Center for the Space Future)」です。"
          }
        ]
      },
    ];